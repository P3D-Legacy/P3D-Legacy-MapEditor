...
FxaaFloat4 FxaaPixelShader(
    ...
    // {xy__} = upper left of pixel
    // {__zw} = lower right of pixel
    // flibitRemoved: FxaaFloat4 fxaaConsolePosPos,
    //
    // Input color texture.
    ...
    // flibitRemoved: FxaaTex fxaaConsole360TexExpBiasNegOne,
    //
    // Only used on the optimized 360 version of FXAA Console.
    // For everything but 360, just use the same input here as for "tex".
    // For 360, same texture, just alias with a 3nd sampler.
    // This sampler needs to have an exponent bias of -2.
    // flibitRemoved: FxaaTex fxaaConsole360TexExpBiasNegTwo,
    //
    ...
    // flibitRemoved: FxaaFloat4 fxaaConsoleRcpFrameOpt,
    //
    // Only used on FXAA Console.
    ...
    // flibitRemoved: FxaaFloat4 fxaaConsoleRcpFrameOpt2,
    //
    // Only used on FXAA Console.
    ...
    // flibitRemoved: FxaaFloat4 fxaaConsole360RcpFrameOpt2,
    //
    // Only used on FXAA Quality.
    ...
    FxaaFloat fxaaQualityEdgeThresholdMin // flibitRemoved: ,
    // 
    // Only used on FXAA Console.
    ...
    // flibitRemoved: FxaaFloat fxaaConsoleEdgeSharpness,
    //
    // Only used on FXAA Console.
    ...
    //   0.25 leaves more aliasing, and is sharper
    // flibitRemoved: FxaaFloat fxaaConsoleEdgeThreshold,
    //
    // Only used on FXAA Console.
    ...
    //   Tune by looking at mostly non-green content,
    //   then start at zero and increase until aliasing is a problem.
    // flibitRemoved: FxaaFloat fxaaConsoleEdgeThresholdMin,
    //    
    ...
    // flibitRemoved: FxaaFloat4 fxaaConsole360ConstDir
) {
/*--------------------------------------------------------------------------*/
    FxaaFloat2 posM;
    posM.x = pos.x;
