...
namespace P3D.Legacy.MapEditor.Data.Models.Blocks
{
    public class PyramidModel : BaseModel<PyramidModel>
    {
        ...
        public PyramidModel(EntityInfo entity, GraphicsDevice graphicsDevice) : base(entity, graphicsDevice)
        {
            ...
            Vertices.Add(new VertexPositionNormalTexture(new Vector3(0, 0.5f, 0), new Vector3(-1, 0, 0), new Vector2(0.5f, 0.0f))); //e
            ...
            Vertices.Add(new VertexPositionNormalTexture(new Vector3(0, 0.5f, 0), new Vector3(0, 0, 1), new Vector2(0.5f, 0.0f))); //e
